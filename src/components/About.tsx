      ...
      <div className="hero-content flex-col lg:flex-row-reverse max-w-6xl mx-auto px-4">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-lg mb-6 text-base-content/80">
            I'm Ezekiel Cruz, an IT student at La Consolacion University of the
            Philippines with 3 years of experience in programming and system
            development. I focus on creating efficient web and mobile
            applications, working with technologies like Java, Python, ReactJS,
            PHP, MySQL, and Flutter. Passionate about learning and
            problem-solving, I'm driven to build impactful solutions and grow as
            an IT professional.
          </p>
